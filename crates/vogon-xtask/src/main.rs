...
const REQUIRED_BUG_VERSION_PLACEHOLDER: &str = "placeholder: \"vogon 0.1.4\"";
...
mod tests {
    ...
    fn reports_missing_first_release_wording() {
        ...
        assert!(errors.contains(&"SECURITY.md: missing \"`v0.1.4` is the latest public release of Vogon Runtime; `v0.1.0` was the first public release.\"".to_owned()));
        fs::remove_dir_all(root).unwrap();
    }

...
const REQUIRED_BUG_VERSION_PLACEHOLDER: &str = "placeholder: \"vogon 0.2.0\"";
...
const REQUIRED_PUBLIC_STATUS_SNIPPETS: &[(&str, &[&str])] = &[
    (
        "README.md",
        &[
            "Vogon Runtime's latest public release is `v0.2.0`; `v0.1.0` was the first\npublic release.",
    ...
    (
        "SECURITY.md",
        &[
            "`v0.2.0` is the latest public release of Vogon Runtime; `v0.1.0` was the first\npublic release.",
...
mod tests {
    ...
    fn reports_missing_first_release_wording() {
        ...
        assert!(errors.contains(&"SECURITY.md: missing \"`v0.2.0` is the latest public release of Vogon Runtime; `v0.1.0` was the first public release.\"".to_owned()));
        fs::remove_dir_all(root).unwrap();
    }
